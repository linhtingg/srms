...
<body>
    ...
    <div id='background' onclick='window.location.href= "https://github.com/linhtingg/" '>
        <header class="py-5 bg-image-full" style="background-image: url('images/2547017-01.png')">
    </header>
    </div>
    <!-- Content section-->
    <section class="py-5">
